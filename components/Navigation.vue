  ...
  <header class="header">
      <nav class="header__nav nav">
          ...
          <ul class="nav__list">
              ...
              <li class="nav__listItem" @click="toggleNav2(); removeOverlay()"><a href="https://drive.google.com/file/d/1OQOi29mOQMTd2rxLEvPrbqvAckiE01iZ/view" target="_blank" class="nav__link">Resume</a></li>
